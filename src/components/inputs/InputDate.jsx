export default function InputDate({ label, value, onChange }) {
  return (
    <fieldset className="group w-full rounded-md border-2 border-black px-3 pb-2 focus-within:border-myGreenD">
      ...
      <input type="date" id={label} value={value} onChange={onChange} className="w-full rounded-md bg-transparent px-2 outline-none" />
    </fieldset>
  );
}
